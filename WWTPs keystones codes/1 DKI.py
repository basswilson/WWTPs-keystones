...
filepath_train = './data/Ptrain.csv'
filepath_test = './data/Ztest.csv' # Replace "Ptest.csv" with "Ztest.csv" for real dataset.
...
np.savetxt('./results/qtst.csv',qtst,delimiter=',')
np.savetxt('./results/qtrn.csv',qtrn,delimiter=',')
